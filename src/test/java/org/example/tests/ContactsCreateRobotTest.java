...
public class ContactsCreateRobotTest {
    ...
    public static void setup() {
        ...
        contactInteractions = new ContactInteractions(driver, contactCreateBot);
    ...
    @Test
    public void createContactWithFirstNameAndPhoneNumber() throws InterruptedException {
    ...
    @Test
    public void createContactWithFirstNameLastNameAndPhoneNumber() throws InterruptedException {
    ...
    @Test
    public void createContactWithPhoneNumber() throws InterruptedException {
    ...
    @Test
    public void createContactWithEmailAddress() throws InterruptedException {
    ...
    @Test
    public void createContactWithStreetAddress() throws InterruptedException {
