...
public class ContactsSortingRobotTest {
    ...
    public void executeSortingTest() throws InterruptedException {
        ...
        backButton.click();
        Thread.sleep(2000);
        List<String> sortedList = getStringContactsWithScrolling();
        Thread.sleep(2000);
        menu = driver.findElement(By.xpath("//android.widget.ImageButton[@content-desc=\"Open navigation drawer\"]"));
        menu.click();
        settings = driver.findElement(By.id("com.android.contacts:id/nav_settings"));
        settings.click();
        ...
        sortBy.click();
        lastName = driver.findElement(By.xpath("//android.widget.CheckedTextView[@resource-id=\"android:id/text1\" and @text=\"Last name\"]"));
        lastName.click();
        backButton = driver.findElement(By.xpath("//android.widget.ImageButton[@content-desc=\"Navigate up\"]"));
        backButton.click();
        Thread.sleep(2000);
        List<String> sortedList2 = getStringContactsWithScrolling();
        Assert.assertEquals(sortedList, sortedList2);
    }

    private List<String> getStringContactsWithScrolling() {
    ...
    private Dimension getNewSize(AppiumDriver driver, By containerLocator) {
